...
const MacTitleBar = () => {
  return (
    <div class={styles.titlebar}>
      <div class={styles.titlebarStoplight}>
        <div class={styles.titlebarClose}>
        ...
        <div class={styles.titlebarMinimize}>
          <svg x="0px" y="0px" viewBox="0 0 8 1.1">
            <rect fill="#995700" width="8" height="1.1"></rect>
          </svg>
        </div>
        <div class={styles.titlebarFullscreen}>
          <svg class={styles.fullscreenSvg} x="0px" y="0px" viewBox="0 0 6 5.9">
            <path
              fill="#006400"
          ...
          <svg class={styles.maximizeSvg} x="0px" y="0px" viewBox="0 0 7.9 7.9">
            <polygon
              fill="#006400"
